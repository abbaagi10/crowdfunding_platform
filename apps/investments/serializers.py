...
class InvestmentSerializer(serializers.ModelSerializer):
    """
    Serializer de consultation des investissements.
    """
    investor_email = serializers.EmailField(source='investor_profile.user.email', read_only=True)
    project_title = serializers.CharField(source='project.title', read_only=True)
    project_status = serializers.CharField(source='project.status', read_only=True)
    project_start_date = serializers.DateField(source='project.start_date', read_only=True)
    ...
    class Meta:
        ...
        fields = (
            ...
            'project', 'project_title', 'project_status', 'project_start_date',
            'company_name',
        ...
        read_only_fields = (
            'id', 'investor_profile', 'investor_email',
            'project', 'project_title', 'project_status', 'project_start_date',
            'company_name', 'transaction', 'transaction_reference',
            'amount', 'amount_refunded', 'remaining_amount',
